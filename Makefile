#############################################################################
# Makefile for building: 461DrawingProject
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  461DrawingProject.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile 461DrawingProject.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = 461DrawingProject1.0.0
DISTDIR = /home/wilsoncm/Projects/classes/461/461DrawingProject/.tmp/461DrawingProject1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
461DrawingProject:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: 461DrawingProject.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		461DrawingProject.pro
	$(QMAKE) -o Makefile 461DrawingProject.pro
...
all: Makefile 461DrawingProject
...
moc_window.cpp: window.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/wilsoncm/Projects/classes/461/461DrawingProject/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/wilsoncm/Projects/classes/461/461DrawingProject -I/home/wilsoncm/Projects/classes/461/461DrawingProject -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/10.2.0 -I/usr/include/c++/10.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/10.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/10.2.0/include-fixed -I/usr/include window.h -o moc_window.cpp
